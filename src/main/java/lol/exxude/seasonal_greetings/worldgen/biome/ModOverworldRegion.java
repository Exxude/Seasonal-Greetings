...
public class ModOverworldRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        ...
        // Overlap Vanilla's parameters with our own for our EASTER ISLAND biome.
        ...
        new ParameterUtils.ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomes.EASTER_ISLAND_BIOME));
...
//            modifiedVanillaOverworldBuilder.replaceBiome(Biomes.PLAINS, ModBiomes.EASTER_ISLAND_BIOME);
//        });
